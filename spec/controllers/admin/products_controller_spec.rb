...
describe Admin::ProductsController do
  ...
  describe "GET index" do
    ...
    it "should have an entry for each product" do
      ...
      @products.each do |product|
        response.should have_selector("td > a", content: product.title)
      end
    end
    ...
    it "should show links for each product" do
      get 'index'
      @products.each do |product|
        response.should have_selector("a", href: admin_product_path(product), content: 'Show')
        response.should have_selector("a", href: edit_admin_product_path(product), content: 'Edit')
  ...
  describe "GET show" do
    ...
    it "should show the right information" do
      ...
      response.should have_selector('.images') do |show|
    ...
    it "should show links" do
      ...
      get :show, {id: @product}, valid_session
      response.should have_selector("a", href: edit_admin_product_path(@product))
      response.should have_selector("a", href: admin_products_path)
    end
